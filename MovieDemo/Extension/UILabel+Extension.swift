...
//  MovieDemo
//
//  Created by ST_Ninn.Wang 王季寧 on 2020/5/4.
//  Copyright © 2020 ST_Ninn.Wang 王季寧. All rights reserved.
//

//import UIKit
//
//protocol ExpandLabelDelegate: AnyObject {
...
//
//    weak var delegate: ExpandLabelDelegate?
//
...
//    open var shouldCollapse: Bool = false
//    open var shouldExpand: Bool = true
...
//
//        if !collapsed { // 收起
//            guard let range = self.expandedLinkTextRange else { return }
//
...
//            }
//        } else { // 展開
//            guard let range = self.collapsedLinkTextRange else { return }
...
//        collapsedAttributedLink = NSAttributedString(string: "展開", attributes: [.font: UIFont.boldSystemFont(ofSize: font.pointSize)])
...
//            let penOffset = CGFloat(CTLineGetPenOffsetForFlush(line, 1.0, Double(textRect.size.width)))
